...
namespace ConsoleApp51.Device.Computer
{
    internal class AllInOneComputer : ElectronicDevice
    {
        ...
        {
            return            $" All In One Computer: {Brand} {Model}\n" +
                              $" Display\n\n" +
                              $" Screen Size: {ScreenSize}\n" +
                              $" Screen Type: {ScreenType}\n" +
                              $" Screen Resolution: {ScreenResolutionWidth} x {ScreenResolutionHeight}\n" +
